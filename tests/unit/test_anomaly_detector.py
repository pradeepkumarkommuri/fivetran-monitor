...
def test_train_returns_pipeline(sample_df: pd.DataFrame):
...
def test_predict_returns_expected_keys(sample_df: pd.DataFrame):
    from src.ml.anomaly_detector import predict, train
